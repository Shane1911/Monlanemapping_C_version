...
struct KdNode {
  ...
  int index;
  int map_index;
  KdNode(const CoordPoint& p, const int& j, void* d = NULL, int i = -1) {
    point = p;
    data = d;
    index = i;
    map_index = j;
...
typedef std::vector<size_t> KdNodeIndexs;
...
class KdTree {
 ...
 public:
  ...
  void k_nearest_neighbors_index(const CoordPoint& point, size_t k,
                                 KdNodeIndexs* result,
